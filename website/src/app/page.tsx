...
export default function NotesApp() {
    ...
    const { data, isLoading, error, fetchNextPage, hasNextPage, isFetchingNextPage, refetch } =
        useInfiniteNotes(selectedSentiment === 'all' ? null : selectedSentiment, NOTES_PER_PAGE);

    const createNoteMutation = useCreateNote();

    const notes = (data?.notes || []).filter((note): note is Note => note !== null);
                ...
                <div className="container mx-auto px-4 py-8 max-w-6xl">
                    <div className="text-center">
                        <div className="flex items-center justify-center gap-3 mb-4">
                            ...
                            <h1 className="text-4xl font-bold text-foreground">Notes Sentiment</h1>
                        </div>
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Capture your thoughts and emotions with intelligent sentiment analysis
                        </p>
