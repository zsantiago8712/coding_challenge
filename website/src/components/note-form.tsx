        ...
        >
          ...
          <div className="bg-muted/30 rounded-lg p-4 border border-border/50">
            <p className="text-sm text-muted-foreground leading-relaxed">
              <strong className="text-foreground">Tip:</strong> Choose the
              sentiment that best reflects your current emotional state. This
              helps you track patterns in your thoughts and feelings over time.
            </p>
          </div>
        </form>
      </div>
