...
import type { Sentiment, QueryGetNotesArgs, NoteQueryResults } from '../graphql/graphql';
 ...
 */
export function useInfiniteNotes(sentiment?: Sentiment | null, limit: number = 10) {
