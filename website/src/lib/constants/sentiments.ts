...
export const SENTIMENT_CONFIG = {
    happy: {
        ...
        styles: {
            ...
            unselected: 'hover:bg-green-50 hover:border-green-300 dark:hover:bg-green-950',
    ...
    sad: {
        ...
        styles: {
            ...
            unselected: 'hover:bg-blue-50 hover:border-blue-300 dark:hover:bg-blue-950',
    ...
    neutral: {
        ...
        styles: {
            ...
            unselected: 'hover:bg-gray-50 hover:border-gray-300 dark:hover:bg-gray-950',
...
export const getSentimentConfig = (sentiment: Sentiment | 'all') => {
    const key =
        sentiment === 'all' ? 'all' : (sentiment.toLowerCase() as keyof typeof SENTIMENT_CONFIG);
